...
import { Button, Dialog, DialogContent, DialogTitle, TextField, Tooltip, Typography, useMediaQuery } from "@mui/material";
    ...
    return (
        <Dialog onClose={handleOnClose} open={open} fullWidth={true} maxWidth={'sm'} sx={{
            ...
            <DialogContent>
                ...
                <TextField fullWidth required id="title" size="small" type="text" inputProps={{
                    maxLength: 50
                }}
                    disabled={loading}
                ...
                <Stack direction={"row"} sx={{
                    ...
                    <Tooltip arrow placement="top" title="Short description about your project."><InfoOutlined fontSize="small" color="action"></InfoOutlined></Tooltip>
                </Stack>
                <TextField fullWidth required id="description" size="small" type="text" multiline sx={{
                    mb: '1rem'
                }}
                    disabled={loading}
