                ...
                <Box sx={{
                    ...
                    <Box display={"flex"} sx={{
                        ...
                        <Button variant="contained" size="small" disableElevation sx={{
                            ...
                            component={Link} noLinkStyle href="/documentation/setup"
                        >Setup Interceptly API
                        </Button>
                        <Typography variant="body2" sx={{
                            ml: '0.5rem'
                        }}>or change filters</Typography>
                    </Box>
                    <Tooltip arrow placement="top-end" title={"If you see this card, it means that there are no issues with these filters. Try to change the filters or check the setup guide by pressing the button."}>
